...
public class AudioPeerSong : MonoBehaviour
{
    AudioSource _audioSource, gameAudioSource;
    public GameObject sourceOfAudioSource;
    ...
    public void ComparePitch(float[] songFreqBand)
    {
        for (int i = 0; i < 8; i++)
        {
    ...
    {
        _audioSource.clip = sourceOfAudioSource.GetComponent<AudioSource>().clip;
